...
padding:24px 0px; font-weight:bold;">
                ...
                <div><a href="{{ url('/instructors/instructors') }}" class="btn btn-primary">講師一覧</a></div>
                ...
                <div class="box1">
                    <div class="d-flex flex-row flex-wrap">
                        ...
                        <div class="div_block">
                            <div class="img_div">
                                <img src="{{ Storage::url($lesson->img)}}" alt="" class="img_instructor">
                            </div>
                            <td>{{ $lesson->id }}</td>
                            ...
                            <div class="btn_div">
                                ...
                                <a href="{{ route('show', $lesson->id ) }}" class="btn btn-primary">詳細</a>
